...
class raindrop():
	...
	def updateTexture(self, bg):		
		...
		#print(np.shape(fisheye))
		#print(np.shape(self.alphamap))
		#print(fisheye.shape[0], fisheye.shape[1])
		self.alphamap = np.resize(self.alphamap, (fisheye.shape[0], fisheye.shape[1]))
